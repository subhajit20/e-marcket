...
function Individualproduct() {
    ...
    return (
        <div className={` ${state.darkmode.individuaTemplateBackground} sm:h-screen h-screen`}><Link to='/' className='sm:relative top-24 left-10 text-3xl'><i className="fa-solid fa-circle-arrow-left "></i></Link><div className='flex justify-center flex-wrap'>{
            flag ? data.map((x, y) => {
